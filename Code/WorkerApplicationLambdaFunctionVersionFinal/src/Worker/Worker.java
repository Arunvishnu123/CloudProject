...
public class Worker implements RequestHandler<SNSEvent, Object> {
  ...
  public static void processExcelFile(SqsClient sqsClient, String queueUrl) {
    try {
      ...
      //receive message from SQS and process it and find the filename and bucket name 
      for (Message i : messages) {
        ...
        for (Message message : messages) {
          DeleteMessageRequest deleteMessageRequest = DeleteMessageRequest
              .builder().queueUrl(queue).receiptHandle(message.receiptHandle())
              .build();
